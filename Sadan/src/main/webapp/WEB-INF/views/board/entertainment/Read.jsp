		...
		<div class="board_body">
			...
			<div class="warp_title">
				...
				<div class="title">
					...
					<a href="#">${entertainment.subject }</a>
				...
				<div class="board_info">
					<div style="float: left; color: gray;">
						...
						<span class="info_st">${entertainment.dates } | </span> 
						 <span class="info_bt">조회 : </span>
						 <span class="info_st">${entertainment.hit } | </span>
						<span  class="info_bt">추천 : </span>
						<span style="color: blue; font-size:10px;">${entertainment.recommand }</span>
					</div>
