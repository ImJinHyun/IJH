...
$(function(){
	...
	$("#sel1 option").each(function(){
		if($(this).val()=="${question.business_type}"){
...
<body>
	<div class="boardhead">
		...
		<div class="warp_boardhead">
			<h3>${question.business_type } 수정</h3>
		</div>
	</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-11">
					<input type="text" class="form-control" id="subject" name="subject"
						placeholder="제목을 입력하세요" value="${question.subject }">
				</div>
			</div>
...
${pageContent.request.contextPath}
	...
	<script>
		$(function() {
			...
			CKEDITOR.instances.ckeditor.setData('<p>${question.content}</p>');//자동엔터키방지
