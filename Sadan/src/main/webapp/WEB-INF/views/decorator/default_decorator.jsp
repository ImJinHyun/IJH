...
<!--[if lt IE 9]>
	...
	<!-- handlebars js 라이브러리. 태그의 형식을 선언하고 데이터를 매칭시켜서 사용할 수 있도록 해준다. -->
	<script src="https://cdnjs.cloudflare.com/ajax/libs/handlebars.js/3.0.1/handlebars.js"></script>
	<script type="text/javascript">
		// 취소 클래스(class="cancelBtn")에 해당이 되는 버튼을 클릭하면 history.back()
		$(function(){
			...
			<nav class="navbar navbar-static-top" role="navigation">
				...
				<div class="navbar-custom-menu">
						<ul class="nav navbar-nav">
							<li>
								<a href="../member/searchIdPw.do"> <i
									class="glyphicon glyphicon-search"></i> ID/PW 찾기
								</a>
							</li>
							<li>
								<a href="../member/registor.do"> <i
									class="fa fa-plus"></i> 회원가입
								</a>
							</li>
							<li>
								<a href="../login/login.do"> <i
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown user user-menu"><a href="#"
							class="dropdown-toggle" data-toggle="dropdown"> <img
								...
								alt="User Image" /> <span class="hidden-xs">${login.name }</span>
						</a>
							<ul class="dropdown-menu">
								<!-- User image -->
								...
								<li class="user-footer">
									...
									<div class="pull-right">
										<a href="../login/logout.do" class="btn btn-default btn-flat">Sign out</a>
									</div>
								</li>
							</ul></li>
						<!-- Control Sidebar Toggle Button -->
			...
			<section class="sidebar">
				...
				<div class="user-panel">
					...
					<div class="pull-left info">
						...
						<a href="#"><i class="fa fa-circle text-success"></i>${login.gradeName }</a>
					</div>
				</div>
				</c:if>
				<!-- search form -->
				...
				<ul class="sidebar-menu">
					...
					<li class="treeview">
						<a href="../board/slist.do"> <i	class="fa fa-dashboard"></i>
						<span>DashBoard</span></a>
					</li>
					<li class="treeview">
						<a href="../image/list.do"> <i class="fa fa-image"></i>
					...
					<li class="treeview">
		                ...
		                <ul class="treeview-menu">
		                	<li><a href="../message/list.do?part=all">
		                		<i class="fa fa-circle-o text-aqua"></i>
		                		<span>전체 메시지</span>
								<small class="label pull-right bg-yellow">23</small>
		                	</a></li>
		                	<li><a href="../message/list.do?part=not">
		                		<i class="fa fa-circle-o text-red"></i>
		                		<span>읽지 않은 메시지</span>
								<small class="label pull-right bg-yellow">12</small>
		                	</a></li>
		                	<li><a href="../message/list.do?part=open">
		                		<i class="fa fa-circle-o text-blue"></i>
		                		<span>읽은 메시지</span>
								<small class="label pull-right bg-yellow">11</small>
		                	</a></li>
						</ul>
					</li>
					</c:if>
