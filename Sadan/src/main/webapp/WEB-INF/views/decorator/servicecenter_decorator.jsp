...
<head>
<meta charset="UTF-8">
<title>18sadan | 고객센터 <decorator:title />
</title>
					...
					<div class="container">
						<div class="row">
							...
							<ul class="nav nav-tabs nav-stacked">
								...
								<li><a href="/servicecenter/board.do?business_type=업소공지사항">업소공지사항</a></li>
								<li><a href="/servicecenter/board.do?business_type=고객문의(일반)">고객문의(일반)</a></li>
								<li><a href="/servicecenter/board.do?business_type=고객문의(업소)">고객문의(업소)</a></li>								   																 
